...
suite("TeamServerContext", function () {

    test("should verify thrown Error for undefined remoteUrl", function () {
        try {
    ...
    test("should verify context is a TeamFoundation context with Azure DevOps Services", function () {
    ...
    test("should verify context is a IsTeamServices and TeamFoundation context", function () {
    ...
    test("should verify context is a TeamFoundation context with TFS account", function () {

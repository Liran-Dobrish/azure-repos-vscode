...
gulp.task('copyresources', gulp.series('clean', function () {
    return gulp.src('resources/**/*')
        .pipe(gulp.dest('out/resources'));
}));

gulp.task('build', gulp.series('copyresources', function () {
...
gulp.task('tslint', gulp.series('build', function () {
...
gulp.task('test-all', gulp.series('test', 'test-integration'));
...
gulp.task('package', gulp.series('publishall', function (cb) {
    exec('vsce package', function (err, stdout, stderr) {
        console.log(stdout);
        console.log(stderr);
        cb(err);
...
gulp.task('default', gulp.series('publishall'));
